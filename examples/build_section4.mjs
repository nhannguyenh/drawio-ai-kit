...
// ---- on-prem (SITE DR) ----
const onprem = frame("op", "ON-PREMISE (the bank · Việt Nam) — SITE DR cho On-Cloud (Nghị định 13)", { dir: "row", gap: 26, fill: "#F0F0F0", stroke: "#666666" }, [
