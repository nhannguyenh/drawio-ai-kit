...
// ---- on-prem (DR SITE) ----
const onprem = frame("op", "ON-PREMISE (the bank · Vietnam) — DR SITE for On-Cloud (Decree 13)", { dir: "row", gap: 26, fill: "#F0F0F0", stroke: "#666666" }, [
